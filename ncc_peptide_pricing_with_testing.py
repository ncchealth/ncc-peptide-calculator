...
# Updated NCC logo
logo = "https://customcompounding.com.au/wp-content/uploads/2023/06/NCC-LOGO-FINAL.png"
...
external_testing_cost = st.number_input("External Lab Testing Cost (AUD)", value=0.0)
...
total_batch_cost = total_api_cost + total_consumables + total_lab_cost + external_testing_cost
...
st.info(f"**Sterile Lab Cost:** ${total_lab_cost:.2f} AUD")
st.info(f"**External Testing Cost:** ${external_testing_cost:.2f} AUD")
